...
export const translations: TranslationMap = {
  ...
  "nav.parent_assistant": { en: "Parent Assistant", ar: "مساعد الأولياء", fr: "Assistant des parents" },
  ...
  "members.linked_hint": { en: "They log in with their Google account. Link them by entering their email.", ar: "يسجلون الدخول بحساب Google الخاص بهم. اربطهم بإدخال بريدهم الإلكتروني.", fr: "Ils se connectent avec leur compte Google. Liez-les en entrant leur e-mail." },
  ...
  "parent_register.login_required":   { en: "You need to log in with your Google account first. Clicking register will redirect you to login, then complete your registration.", ar: "يجب عليك تسجيل الدخول بحساب Google أولاً. سيُحوّلك الضغط على التسجيل لتسجيل الدخول ثم إكمال التسجيل.", fr: "Vous devez vous connecter avec votre compte Google. Cliquer sur s'inscrire vous redirigera." },
